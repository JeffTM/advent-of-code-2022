...
namespace Day5
{
    ...
    inline void Part1()
    {
        ...
        for (const MoveInstruction& Instruction : MoveInstructions)
        {
            ...
            ToStack.insert(ToStack.end(), FromStack.rbegin(), FromStack.rbegin() + Instruction.Count);
            FromStack.resize(FromStack.size() - Instruction.Count);
        }
    ...
    inline void Part2()
    {
        ...
        for (const MoveInstruction& Instruction : MoveInstructions)
        {
            ...
            ToStack.insert(ToStack.end(), FromStack.end() - Instruction.Count, FromStack.end());
            FromStack.resize(FromStack.size() - Instruction.Count);
        }
